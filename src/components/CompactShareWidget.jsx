...
const CompactShareWidget = ({ article }) => {
  ...
  const copyLink = () => {
    navigator.clipboard.writeText(currentUrl).then(() => {
      ...
      btn.innerHTML = '<span class="text-green-600">✓ Tersalin!</span>';
      setTimeout(() => {
    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg 
              className="w-4 h-4 text-slate-600 group-hover:text-sky-600 transition-colors" 
              fill="currentColor" 
              viewBox="0 0 24 24"
            >
          ...
          >
            <svg 
              className="w-4 h-4 text-slate-600 group-hover:text-green-600 transition-colors" 
              fill="currentColor" 
              viewBox="0 0 24 24"
            >
          ...
          >
            <Share2 className="w-4 h-4 text-slate-600 group-hover:text-slate-800 transition-colors" />
...
export default CompactShareWidget;